                                            ...
                                            "py_function_call": {
                                                ...
                                                "method": function (argNum) {
                                                    ...
                                                    if (surface.value.name === "pygame:display.screenSurface@instance") {
                                                        ctx2 = AppWorker.getInstance().getContext2D();
                                                    }
                                        ...
                                        "set_colorkey": {
                                            ...
                                            "py_function_call": {
                                                ...
                                                "method": function () {
                                                    ...
                                                    let g = Math.floor(pos.value[1].value);
                                                    let b = Math.floor(pos.value[2].value);
                                                    let imageData = AppWorker.getInstance().getContext2D().getImageData(0, 0, AppWorker.getInstance().getContext2D().canvas.width, AppWorker.getInstance().getContext2D().canvas.height);
                                                    for (let i = 0; i < imageData.data.length; i += 4) {
                                                        if (imageData.data[i] === r && imageData.data[i + 1] === g && imageData.data[i + 2] === b) {
                                                            imageData.data[i + 3] = 0;
                                                        }
                                                    }
                                                    AppWorker.getInstance().getContext2D().putImageData(imageData, 0, 0);
                                                    PythonRuntime.storage.varStack.push(PyObjectFactory.constructPyObjectNone());
                                                }
                                            },
                                            "$": ""
                                        ...
                                        "blit": {
                                            ...
                                            "py_function_call": {
                                                ...
                                                "method": function (argNum) {
                                                    ...
                                                    if (argNum == 3) {
                                                        AppWorker.getInstance().getContext2D().drawImage(ctx2.canvas, sourceRect.value[0].value, sourceRect.value[1].value, sourceRect.value[2].value, sourceRect.value[3].value, pos.value[0].value, pos.value[1].value, sourceRect.value[2].value, sourceRect.value[3].value);
                                                    }
                                                    else {
                                                        AppWorker.getInstance().getContext2D().drawImage(ctx2.canvas, pos.value[0].value, pos.value[1].value);
                                                    }
                                                    PythonRuntime.storage.varStack.push(PyObjectFactory.constructPyObjectNone());
                                                }
                                            },
                                        ...
                                        "fill": {
                                            ...
                                            "py_function_call": {
                                                ...
                                                "method": function () {
                                                    ...
                                                    AppWorker.getInstance().getContext2D().fillStyle = StringFormat("rgb({},{},{})", [
                                                        PyObject0.value[0].value.toString(),
                                                        PyObject0.value[1].value.toString(),
                                                        PyObject0.value[2].value.toString()
                                                    ]);
                                                    AppWorker.getInstance().getContext2D().fillRect(0, 0, AppWorker.getInstance().getCanvas().width, AppWorker.getInstance().getCanvas().height);
                                                    PythonRuntime.storage.varStack.push(PyObjectFactory.constructPyObjectNone());
                                                }
                                            },
                                            "$": ""
